...
methodsfile <-paste ("../METHODS/",vizmetadata$art_methodsfile,sep="")
...
shinyUI(
  ...
  dashboardPage(skin="blue",
    ...
    dashboardHeader(
        	 titleWidth="95%",
	         title =div(includeHTML("http://psesv.psmfc.org:4949/dashboardheader.html"))
    ...
    dashboardBody(
      tags$head( includeCSS(path="http://psesv.psmfc.org:4949/style/appstyle.css")),
          ...
          tabPanel("Distributions",
            sidebarLayout(
             sidebarPanel(width=3,
                  ...
                  radioButtons(inputId ="survey.dis", 
                               label = h4("Survey"), 
                  ...
                  # radioButtons(inputId ="AREA_W.dis",width="100%", 
                  ...
                  selectInput(inputId ="plotT.dis",width="100%",
                              label = h4("Plot"), 
                              choices = list(
                                             'Temp. and depth' = 5,
                  ...
                  selectInput(inputId ="species.dis",width="100%",
                              label = h4("Species"), 
        ...
        tabPanel("Lengths",
          sidebarLayout(
            sidebarPanel(width=3,
                radioButtons(inputId ="survey.len", 
                             label = h4("Survey"), 
                             choices = list("Western GOA" = 46,
                                            "Central GOA" = 47,
                                            "Eastern GOA" = 48,
                ...
                selectInput(inputId ="species.len",width="100%",
                            label = h4("Species"), 
                            choices = choicesSpecies,
                            selected = 21720)),
            mainPanel(
